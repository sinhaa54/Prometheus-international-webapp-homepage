 ...
 */
export function DashboardCard({ dashboard, pinned, onOpen, onTogglePin, accentColor, requestAccessUrl }) {
    ...
    return (_jsxs("div", { className: "card", style: style, role: "button", tabIndex: 0, "aria-label": `Open ${dashboard.dashboard_name} in Tableau`, onClick: () => onOpen(dashboard), onKeyDown: (e) => {
        ...
        }, children: [_jsx("h3", { className: "card__name", children: dashboard.dashboard_name }), _jsx("button", { type: "button", className: `fav ${pinned ? 'on' : ''}`, "aria-label": pinned ? 'Unpin dashboard' : 'Pin dashboard', "aria-pressed": pinned, onClick: (e) => { e.stopPropagation(); onTogglePin(dashboard); }, children: pinned ? '\u2605' : '\u2606' }), _jsxs("div", { className: "card__row", children: [dashboard.category && _jsx("span", { className: "chip", children: dashboard.category }), dashboard.market && _jsx("span", { className: "card__meta", children: dashboard.market })] }), hasTooltip && (_jsxs("div", { className: "tip", role: "tooltip", children: [dashboard.dashboard_description && (_jsx("div", { className: "tip__desc", children: dashboard.dashboard_description })), dashboard.owner_name && (_jsxs("div", { className: "tip__owner", children: [_jsxs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", children: [_jsx("circle", { cx: "12", cy: "8", r: "4" }), _jsx("path", { d: "M4 20c0-4 3.6-6 8-6s8 2 8 6" })] }), _jsx("span", { className: "tip__owner-label", children: "Owner" }), _jsx("span", { className: "tip__owner-name", children: dashboard.owner_name })] })), requestAccessUrl && (_jsxs("div", { className: "tip__access", children: [_jsx("span", { className: "tip__access-label", children: "Request Access:" }), _jsx("a", { href: requestAccessUrl, target: "_blank", rel: "noopener noreferrer", onClick: (e) => e.stopPropagation(), children: "Link" })] }))] }))] }));
}
